...
- [Deployment](#deployment)
  ...
  - [Creating a Branch from Main](#creating-a-branch-from-main)
...
A dark-themed UI with vibrant accent colors to reflect a dynamic and creative atmosphere.

### Font

The project uses **Poppins** for headlines and **Lato** for body text to enhance readability and maintain a professional yet artistic feel.

### Project Planning

The project follows Agile methodologies, utilizing Trello for task tracking and sprint planning.
...
- **Data Protection:** Secure storage of user data using PostgreSQL.
- **Input Validation & Sanitization:** Preventing SQL injection and XSS attacks.
- **Authorization:** User roles and permissions to limit actions.
- **Secure API Keys:** Environment variables for sensitive credentials.

## Tools & Programs

The following tools and software were used in the project:

- **Code Editor:** Visual Studio Code
- **Version Control:** GitHub
- **Task Management:** Trello (Agile methodology)
- **Database Management:** Elephant SQL
- **Hosting & Deployment:** Heroku
- **Media Storage:** Cloudinary
- **Design & Wireframing:** Balsamiq
